...
def MNisttrainNN(net, batch_size, epochs, lr,train_loader,test_loader, classes):
    ...
    plt.title('Training Poisson negative log likelihood loss')
    plt.ylabel('Error')
    plt.xlabel('Trials')
    plt.show()

    plt.plot(trialVset, lossVset)
    plt.title('Validation Poisson negative log likelihood loss')
    plt.ylabel('Error')
    plt.xlabel('Trials')
    plt.show()
